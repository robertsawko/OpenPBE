from numpy import genfromtxt, pi, linspace, cumsum
from scipy.interpolate import interp1d
from scipy.integrate import trapz
# import matplotlib.pyplot as plt


def calculate_MOC_initial_condition(U=0.177, D=0.03):
    ...
    v = linspace(0, 1.2 * max(v_data), 101)
    dv = v[1]
    ...
    return dv, N0 * (cdf_empirical[1:] - cdf_empirical[:-1])
